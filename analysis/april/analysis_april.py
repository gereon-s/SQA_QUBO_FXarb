...
# --- Configuration ---
SQA_RESULTS_CSV = "../../oos_test_april/output/sqa_results_april.csv"
BF_RESULTS_CSV = "../../oos_test_april/output/bf_results_april.csv"
...
def analyze_results():
    ...
    summary_metrics_list = []  # Use list of dicts for df creation
    for method_name, group_df in df_all.groupby("method"):
        # Total profit is sum of all individual cycle profits
